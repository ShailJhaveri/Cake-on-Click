...
$q2=mysqli_query($connection,"select * from cake where cake_id=".$_GET['cake_id']);
$cake=mysqli_fetch_assoc($q2);
?>
<header>
...
<form class="jotform-form" action="check.php?action=edit&cake_id=<?php echo($_GET['cake_id']);?>" method="post" enctype="multipart/form-data" name="addcake" id="addcake" accept-charset="utf-8" onsubmit="return required()">
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_50">
        ...
        <div id="cid_50" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_50" name="cakename" size="20" value="<?php echo($cake['Cakename']);?>"/>
        </div>
      </li>
      <li class="form-line jf-required"  data-type="control_number" id="id_51">
        ...
        <div id="cid_51" class="form-input jf-required">
          <input type="number" class="form-number-input  form-textbox validate[required]" id="input_51" name="price" style="width:60px" size="5" value="<?php echo($cake['Price']);?>" data-type="input-number" />
        </div>
      </li>
      <li class="form-line"  id="id_new">
        <label class="form-label form-label-left form-label-auto" id="label_52" for="input_52" >Current Photo </label>
        <div id="cid_new" class="form-input jf-required" style="width:100%;">
         <img src="<?php echo('../'.$cake['path']);?>" style="max-width:60%;">
        </div>
      </li>
	  <li class="form-line" data-type="control_fileupload" id="id_52">
        <label class="form-label form-label-left form-label-auto" id="label_52" for="input_52" >Change Photo </label>
      ...
      <li class="form-line" data-type="control_textarea" id="id_53">
        ...
        <div id="cid_53" class="form-input jf-required">
          <textarea id="input_53" class="form-textarea" name="details" cols="40" rows="6" ><?php echo($cake['Details']);?></textarea>
        </div>
      </li>
      <li class="form-line" data-type="control_scale" id="id_54">
        ...
        <div id="cid_54" class="form-input jf-required">
          <table summary="" cellpadding="4" cellspacing="0" class="form-scale-table">
            <tr>
		      ...
		      ?>
			  <th align="center">
                <label for="input_54_1"><?php echo $count?></label>
              </th>
              <?php
			   $count++;
			  }
            ...
            <tr>
			  ...
			  <td align="center">
			  <?php 
			  if($count==$cake['Rating'])
			  {
			?>
                <input class="form-radio" type="radio" name="rating" value="<?php echo $count?>" title="<?php echo $count?>" id="<?php echo ('input_54'.$count);?>" checked />
              <?php
			  }
			  else
			  {
		?>
                ...
                <input class="form-radio" type="radio" name="rating" value="<?php echo $count?>" title="<?php echo $count?>" id="<?php echo ('input_54'.$count);?>" />
			  <?php 
			  }
			  ?>
			  </td>
...
<?php
if($cat['category_code']==$cake['category_no'])
{
	?>
...
{	
?>
<input type="radio" class="form-radio validate[required]" id="input_55_0" name="category"  value="<?php echo($cat['category_code']);?>" />
              <label id="label_input_55_0" for="input_55_0"><?php echo($cat['category_name']);?></label>
            </span>
<?php
}
