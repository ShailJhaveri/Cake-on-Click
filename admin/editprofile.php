...
<?php   $connection = mysqli_connect("localhost", "root");
									...
									?>
<center>
<?php echo '<img src="../'.$p1['path'].'" alt="header img" height="200px" width="200px">'?>
</center>
<!--breadcrumb -->
...
<div class="container">
    ...
    <form class="well form-horizontal" enctype="multipart/form-data" action="check.php?action=profile" method="post"  id="contact_form">
...
<!-- Form Name -->
  ...
  <input  name="fname" placeholder="First Name" class="form-control"  type="text" value="<?php echo $p1['Name']?>">
    </div>
  </div>
</div>
<div class="form-group">
