...
<div class="col-sm-6 get-in-touch pull-right text-right text-capitalize"><ul><li><p>get in touch:<a href="#">coc@yummycake.com</a></p></l</div>
...
<form class="jotform-form" action="checker.php" method="post" enctype="multipart/form-data" name="addshop" id="addshop" accept-charset="utf-8" onsubmit="return required()">
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_50">
        ...
        <div id="cid_50" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_50" name="shopname" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_50">
        <label class="form-label form-label-left form-label-auto" id="label_50" for="input_50">
        ...
        <div id="cid_50" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_50" name="cakeshop_id" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_50">
        <label class="form-label form-label-left form-label-auto" id="label_50" for="input_50">
        ...
        <div id="cid_50" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_50" name="password" size="20" value="" />
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="margin-left:156px" class="form-buttons-wrapper">
            <button id="input_2" type="submit" class="form-submit-button form-submit-button-steel" name="addshop">
              Add Shop
            </button>
          </div>
        </div>
