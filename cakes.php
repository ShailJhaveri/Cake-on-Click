...
<nav class="pagination">
 ...
 ?>
	...
	<li class="page-item">
	  ...
	  {
		  ?>
	  <a class="page-link" href="cakes.php?page=<?php echo($page-1);?>" aria-label="Previous">
        <?php
	  }
	  if(isset($_GET['cat_id']))
	  {
		  ?>
	  <a class="page-link" href="cakes.php?cat_id=<?php echo $_GET['cat_id']?>&page=<?php echo($page-1)?>" aria-label="Previous">
	<?php
	  }
	?>
        <span aria-hidden="true">&laquo;</span>
	...
	{
		$q1=mysqli_query($connection,"select * from cake");
	}
	...
	?>    
	 ...
	 <li class="page-item active">
      <a class="page-link" href="cakes.php?cat_id=<?php echo $_GET['cat_id']?>&page=<?php echo $count?>"><?php echo $count?><span class="sr-only">(current)</span></a>
    </li>
    <?php 
	}
	if(!isset($_GET['cat_id']))
	{
		?>
	<li class="page-item active">
      <a class="page-link" href="cakes.php?page=<?php echo $count?>"><?php echo $count?><span class="sr-only">(current)</span></a>
    </li>
<?php	
	}
	}
	...
	?>    
	 ...
	 <li class="page-item">
      <a class="page-link" href="cakes.php?cat_id=<?php echo $_GET['cat_id']?>&page=<?php echo $count?>"><?php echo $count?>
    </li>
    <?php 
	}
	if(!isset($_GET['cat_id']))
	{
		?>
	<li class="page-item">
      <a class="page-link" href="cakes.php?page=<?php echo $count?>"><?php echo $count?></a>
    </li>
	<?php
	}
	}
	...
	<li class="page-item">
	  ...
	  {
		  ?>
	  <a class="page-link" href="cakes.php?page=<?php echo($page+1);?>" aria-label="Next">
        <?php
	  }
	  if(isset($_GET['cat_id']))
	  {
		  ?>
	  <a class="page-link" href="cakes.php?cat_id=<?php echo($_GET['cat_id']);?>&page=<?php echo($page+1);?>" aria-label="Next">
	<?php
	  }
	?>
		<span aria-hidden="true">&raquo;</span>
            ...
            <ul class="nav nav-list">
                <li><label class="tree-toggle nav-header">Categories</label>
                    <ul class="nav nav-list tree">
						<li><a href="cakes.php?cat_id=<?php echo('1')?>">Choclate Cakes</a></li>
                        <li><a href="cakes.php?cat_id=<?php echo('2')?>">Non Choclate Cakes</a></li>
                        <li><a href="cakes.php?cat_id=<?php echo('3')?>">Cup Cakes</a></li>
...
{
$q2 = mysqli_query($connection,"select * from cake LIMIT $start_from,$per_page");	
